...
function Projects() {
  ...
  const allProjects = [
    ...
    { src: Hom, link: "https://homchang.in/", title: "Homchang", description: "News website with admin panel for article creation and utilities  ", skill: "Tools" },
    { src: Lotus, link: "https://lotuseducation.tech/", title: "Lotus Education", description: "Course selling website complete with LMS page and payment gateway", skill: "Web Designs" },
